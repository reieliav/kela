...
from dev.types.radar_data import RadarData


def calc_polar_los(path_ned_data: NedData, radar_data: RadarData) -> PolarData:
    ...
    return PolarData(r=ranges, az=azimuth, el=elevation)
